...
from .utils import is_punctuation, is_whitespace

BASE_PATH = 'models/render'
...
def test():
    set_font(FALLBACK_FONTS[0])
    #canvas = put_text_vertical(64, 1.0, '因为不同‼ [这"真的是普]通的》肉！那个“姑娘”的恶作剧！是吗？咲夜⁉。', 700, (0, 0, 0), (255, 128, 128))
    canvas = put_text_vertical(64, '因为不同‼ [这"真的是普]通的》肉！那个“姑娘”的恶作剧！是吗？咲夜⁉', 400, 'center', fg=(0, 0, 0), bg=(255, 128, 128), line_spacing=1.0)
